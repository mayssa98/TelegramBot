...
TRANSLATIONS = {
    ...
    "affiliate_ten_success": {
        "fr": "✅ *Objectif atteint !*\n\nVous avez complété *5 filleuls valides*. *1 USDT* a été ajouté automatiquement à votre portefeuille.\n\nNouveau solde : *{balance} USDT*.",
        "en": "✅ *Goal completed!*\n\nYou completed *5 valid referrals*. *1 USDT* was automatically added to your wallet.\n\nNew balance: *{balance} USDT*.",
        "ar": "✅ *تم تحقيق الهدف!*\n\nأكملت *5 إحالات صالحة*. تمت إضافة *1 USDT* تلقائيًا إلى محفظتك.\n\nالرصيد الجديد: *{balance} USDT*.",
    },
    "quantity_invalid": {
