...
LTC_MIN_CONFIRMATIONS: int = max(
    1, int(os.environ.get("HP_LTC_MIN_CONFIRMATIONS", "3"))
)
LTC_MIN_DEPOSIT: float = max(
    0.00000001, float(os.environ.get("HP_LTC_MIN_DEPOSIT", "0.001"))
)
